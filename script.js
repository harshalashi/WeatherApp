...
function onSuccess(position) {
  ...
  api = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=885d71bccad3fb81d06c45288ce7b105`;
  fetchData();
}
...
function requestApi(city) {
  api = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=885d71bccad3fb81d06c45288ce7b105`;
  fetchData();
}
